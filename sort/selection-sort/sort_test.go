...
func TestSelectionSortString(t *testing.T) {
	...
	selectionSort.SortString(stringArray)
...
func TestSelectionSortSlice(t *testing.T) {
	...
	selectionSort.SortSlice(personArray, func(p1, p2 Person) int {
		if p1.Age < p2.Age {
			return -1
