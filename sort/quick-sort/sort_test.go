...
func TestQuickSortString(t *testing.T) {
	...
	quickSort.SortString(stringArray)
...
func TestQuickSortSlice(t *testing.T) {
	...
	quickSort.SortSlice(personArray, func(p1, p2 Person) int {
		if p1.Age < p2.Age {
			return -1
