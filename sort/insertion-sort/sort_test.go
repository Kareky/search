...
func TestInsertionSortString(t *testing.T) {
	...
	insertionSort.SortString(stringArray)
...
func TestInsertionSortSlice(t *testing.T) {
	type Person struct {
		Name string
		Age  int
	}
	...
	insertionSort.SortSlice(personArray, func(p1, p2 Person) int {
		if p1.Age < p2.Age {
			return -1
